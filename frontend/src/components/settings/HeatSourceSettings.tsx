...
import type { HeatSourceYaml, SourceSelectionYaml, QshConfigYaml } from '../../types/config'
...
export function HeatSourceSettings({ heatSource, heatSources, sourceSelection, rootConfig, onRefetch }: HeatSourceSettingsProps) {
  ...
  const updateSensor = (key: string, value: string) => {
    setHs({ ...hs, sensors: { ...hs.sensors, [key]: value || undefined } })
  }
